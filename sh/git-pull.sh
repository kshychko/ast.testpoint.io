...
declare -a REPO_NAMES=("ausdigital-bill" "ausdigital-code" "ausdigital-dcl" "ausdigital-dcp" "ausdigital-idp" "ausdigital-nry" "ausdigital-syn" "ausdigital-tap" "ausdigital-tap-gw")
